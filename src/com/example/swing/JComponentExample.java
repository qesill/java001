...
class TestJComponent extends JComponent {
    ...
    public TestJComponent() {
        super();
        img = new ImageIcon("files\\stock-illustration-8081282-black-compass-rose.jpg").getImage();
    ...
    public void paintComponent(Graphics g) {
        ...
        g2d.draw(new RoundRectangle2D.Float(50.0f,40.0f,100.0f,40.0f,
                                            10.0f,10.0f));

        GradientPaint gp = new GradientPaint(5,5,Color.YELLOW,20,25,
                                                Color.RED,true);
        g2d.setPaint(gp);
